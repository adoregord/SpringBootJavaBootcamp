...
import com.example.authDemo.model.SmsGatewayRequest;
import com.example.authDemo.model.SmsGatewayResponse;
...
public class SmsGatewayController {
    ...
    public ResponseEntity<?> sendSms(@RequestBody SmsGatewayRequest smsGatewayRequest){
        ...
        HttpEntity<SmsGatewayRequest> entity = new HttpEntity<>(smsGatewayRequest, headers);
